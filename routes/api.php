...
Route::get('generos/delete/{id}', 'GenerosController@delete')->name('deleteGenero');
...
Route::get('directores/delete/{id}', 'DirectoresController@delete')->name('deleteDirector');
...
Route::get('salas/delete/{id}', 'SalasController@delete')->name('deleteSala');
...
Route::get('carteleras/delete/{id}', 'CartelerasController@delete')->name('deleteCartelera');
...
Route::get('peliculas/delete/{id}', 'PeliculasController@delete')->name('deletePelicula');
...
Route::get('reservas/delete/{id}', 'ReservasController@delete')->name('deleteReserva');